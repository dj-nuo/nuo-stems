...
:::important
These colors apply only to newly coverted STEMS. If you already processed STEM file & want to change it's colors - please use [Traktor Utilities](../../traktor-utilities), where these colors will be used.
:::
