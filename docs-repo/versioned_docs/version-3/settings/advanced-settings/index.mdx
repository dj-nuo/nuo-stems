...
100ms of additional silence gives headroom for [Traktor Utilities](../../traktor-utilities/) to align the start of the track in different software and sync beatgrids & hotcues.
:::