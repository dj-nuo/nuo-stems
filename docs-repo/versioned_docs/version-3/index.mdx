---
sidebar_position: 0
title: Getting Started NUO-STEMS 3
---

:::info
*These docs are for NUO-STEMS 3. For NUO-STEMS 4, please see [NUO-STEMS 4 documentation](/docs/intro/).*
:::

# Getting Started with NUO-STEMS 3
...
You can save individual stems (drums, bass, other, vocals) additionally as .wav by enabling the **"Save .wav"** option in the [Settings](/docs/v3/settings/general-settings/).
:::
...
:::tip
See [Traktor Utilities - Recommended workflow](./traktor-utilities/general#recommended-workflow) for opinionated guide on how to use STEMS in Traktor Pro in combination with NUO-STEMS.
:::