...
### Bugs:
- [ ] Huge Traktor collection.nml (e.g. 380 MB, 190k tracks) causing app to crash. So far I haven't found ANY solution to fix this. This seems to be a hard Electron limitation enforcing 4GB memory limit (https://www.electronjs.org/blog/v8-memory-cage)

### Hypothetical feature list:
- [x] Support AMD GPUs acceleration.
- [x] Serato integration.
...
### Left for history:
- [x] How to use another computer to convert stems? - already implemented in NUO-STEMS 4 - see [migrate .stem.m4a to natively linked TP4 stems](/docs/utilities/migrate-stem-m4a-to-tp4)
    <details>
