...
- [x] Ability to have CUDA GPU acceleration on Windows on GTX1080 series (not just RTX20xx and later series)

### General bugs:
- [x] Fixed resizing of algorithm filter on Traktor Pro 4 tab
...
## Feature list:
- [x] Custom collection.nml file selection in Traktor Pro 4 tab. Persist selection between app restarts. Show icon that collection.nml is not default.
- [x] "Hide track in Queue" checkbox on Traktor Pro 4 tab.
