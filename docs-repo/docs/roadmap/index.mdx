...
The issue I'm having with this feature is this:
I can set the tag. But what should happen when you Remove Stems from Traktor UI?
What should happen when you Remove Stems from NS4 UI?
What should happen when you re-generate Stems in NS4 with different algorithm?
What should happen if at any of these steps user manually changes tag in Traktor and NS4 can't identify the tag anymore (to remove or change)?

Maybe there are more use cases, but these are the most obvious
...
- [ ] Low priority: Offline licensing. Ability to use NUO-STEMS 4 without an internet connection.

### Bugs:
- [ ] Long tracks (e.g. 30 minutes and more) crash the app.
